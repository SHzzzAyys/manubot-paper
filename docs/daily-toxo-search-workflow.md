...
```powershell
powershell -ExecutionPolicy Bypass -File scripts\run_daily_toxo_search.ps1 -Days 1
```
...
```powershell
powershell -ExecutionPolicy Bypass -File scripts\register_daily_toxo_search_task.ps1
```
...
```powershell
powershell -ExecutionPolicy Bypass -File scripts\register_daily_toxo_search_task.ps1 -Time "07:00" -Days 1
```
