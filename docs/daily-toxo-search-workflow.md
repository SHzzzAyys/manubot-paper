...
```text
查最近 24 小时到 7 天内与弓形虫相关的新文献。请分成两层：
1. 核心检索：疫苗、免疫、减毒、抗原、佐剂、猫模型、卵囊排出
2. 外围补充检索：缓殖子、囊形成、有性发育、顶质体、关键靶点、阶段变化、药物诱导变化
...
```text
查最近 7 天内与猫弓形虫、卵囊排出、猫模型免疫相关的新文献，并按优先级整理。
```
...
- 但对弓形虫这类生物医学主题，`PubMed` 已经能覆盖大多数高价值新文献
